...
<center> <div class="parallax" style="margin-left:1%;">
</br></br>

		<h3 style="margin-left: 10%;">Item Search: <input height="32" width="128" type="text" id="kwd_search" placeholder=""></h3>
	...
	<script>
		...
		var cols = 3; //Number of columns in speadsheet
		var table = "<table style=\"margin-left: 10%; \" class=\"sortable\" cellpadding=\"5\" id=\"table\">";
